      ...
      if (stepIndex >= updatedFlow.steps.length) {
        const completedFlow = {
          ...
          steps: updatedFlow.steps.map((s) => ({
            ...
            duration: `${2 + Math.floor(Math.random() * 8)}s`,
            score: s.type === "validate" ? 94 + Math.floor(Math.random() * 6) : s.score,
          })),
        };
    ...
    <div className="h-[calc(100vh-0px)] flex flex-col bg-background">
      ...
      <div className="flex items-center justify-between px-6 h-12 border-b bg-card flex-shrink-0" style={{ borderColor: "var(--border)" }}>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link href="/studio/production" className="flex items-center gap-1.5 text-muted-foreground hover:text-foreground transition-colors" style={{ fontSize: "12px" }}>
            Asset Builder <ArrowRight size={11} />
          </Link>
        </div>
      </div>
    ...
    <div>
            ...
            <div key={step.id} className="relative">
              ...
              {i < flow.steps.length - 1 && (
                <div
                  ...
                  style={{
                    ...
                    background: isDoneStep ? "var(--ora-signal)" : "var(--border)",
                  }}
                />
              )}
              <motion.div
              ...
              >
                ...
                <div
                  ...
                  style={{
                    background: isDoneStep ? "var(--ora-signal)" : isActive ? "var(--ora-signal-light)" : "var(--card)",
                    borderColor: isDoneStep ? "var(--ora-signal)" : isActive ? "rgba(59,79,196,0.3)" : "var(--border)",
                  }}
                >
                  {isDoneStep ? (
      ...
      {isDone && (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="mt-6 flex items-center gap-3 pt-4 border-t" style={{ borderColor: "var(--border)" }}>
          ...
          <Link href="/studio" className="flex items-center gap-2 px-4 py-2 rounded-lg border hover:bg-secondary transition-colors" style={{ borderColor: "var(--border)", fontSize: "12px", fontWeight: 500 }}>
