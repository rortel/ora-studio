...
const planData: Record<PlanTier, PlanDetails> = {
  free: {
    ...
    agents: 1, maxAgents: 1,
    contentUsed: 3, contentMax: 5,
    vaults: 0, maxVaults: 0,
    campaigns: 0, maxCampaigns: 0,
    storageUsed: 0.02, storageMax: 0.1,
    renewalDate: "--",
  ...
  starter: {
    ...
    contentUsed: 12, contentMax: 20,
    vaults: 1, maxVaults: 1,
    campaigns: 2, maxCampaigns: 3,
    storageUsed: 0.8, storageMax: 5,
  ...
  agency: {
    ...
    period: "/mo",
    color: "var(--ora-signal)",
    agents: 15, maxAgents: 15,
    contentUsed: 64, contentMax: 100,
    vaults: 3, maxVaults: 5,
    campaigns: 8, maxCampaigns: -1,
    storageUsed: 12.4, storageMax: 50,
    renewalDate: "Apr 4, 2026",
  ...
  enterprise: {
    ...
    color: "#d4a853",
    agents: 15, maxAgents: 15,
    contentUsed: 312, contentMax: -1,
    vaults: 8, maxVaults: -1,
    campaigns: 24, maxCampaigns: -1,
    storageUsed: 48.2, storageMax: -1,
            ...
            return (
              <button
                ...
                className={`flex items-center gap-1.5 px-4 py-2.5 border-b-2 transition-all -mb-px ${
                  isActive
                    ? "border-ora-signal text-foreground cursor-pointer"
                    : isLocked
...
function PlanBadge({ plan }: { plan: PlanTier }) {
  const config = {
    free: { label: "Free", bg: "var(--secondary)", color: "var(--muted-foreground)", icon: false },
    starter: { label: "Starter", bg: "var(--ora-signal-light)", color: "var(--ora-signal)", icon: false },
    agency: { label: "Agency", bg: "var(--ora-signal-light)", color: "var(--ora-signal)", icon: true },
    enterprise: { label: "Enterprise", bg: "rgba(212,168,83,0.1)", color: "#d4a853", icon: true },
  }[plan];
      ...
      <div className="space-y-6">
            ...
            <div className="flex items-center justify-between mb-5">
              ...
              {!isSubscriber ? (
                ...
                <div className="flex items-center gap-2">
                  ...
                  <Link href="/studio/credits" className="px-3 py-1.5 rounded-md border hover:bg-secondary transition-colors" style={{ borderColor: "var(--border)", fontSize: "11px", fontWeight: 500 }}>
                    Manage
                  </Link>
                </div>
              )}
          ...
          {!isSubscriber && (
            <div className="border-t px-5 py-4 bg-ora-signal-light/20" style={{ borderColor: "var(--border)" }}>
              <div className="flex items-center gap-3">
                ...
                <Link href="/studio/credits" className="text-ora-signal flex items-center gap-1" style={{ fontSize: "12px", fontWeight: 500 }}>
        ...
        <div className="border rounded-xl bg-card p-5" style={{ borderColor: "var(--border)", boxShadow: "0 1px 2px rgba(0,0,0,0.02)" }}>
          <div className="flex items-center justify-between mb-4">
            ...
            <Link href="/studio/chat" className="flex items-center gap-1 text-ora-signal" style={{ fontSize: "11px", fontWeight: 500 }}>
...
function QuickAccess({ isSubscriber }: { isSubscriber: boolean }) {
  const items = [
    { label: "AI Hub", desc: "Generate with multiple models", href: "/studio/chat", icon: Sparkles, locked: false },
    { label: "Remix", desc: "Paste anything, get your brand's version", href: "/studio/remix", icon: RefreshCcw, locked: !isSubscriber },
    { label: "Flows", desc: "Chain AI operations", href: "/studio/flows", icon: GitBranch, locked: !isSubscriber },
    ...
    { label: "Credits", desc: "Manage your plan", href: "/studio/credits", icon: TrendingUp, locked: false },
  ];
          ...
          <div className="border rounded-xl bg-card overflow-hidden" style={{ borderColor: "var(--border)", boxShadow: "0 1px 2px rgba(0,0,0,0.02)" }}>
            {section.items.map((item) => (
              ...
              >
                ...
                <div className="flex items-center gap-3">
                  <span style={{ fontSize: "12px", color: "var(--muted-foreground)", opacity: item.editable ? 1 : 0.4 }}>
                    {item.value}
                  </span>
                  {item.editable ? (
