          ...
          <table className="w-full min-w-[760px]">
            <thead>
              <tr style={{ borderBottom: "1px solid var(--border)" }}>
                <th className="text-left p-4" style={{ fontSize: "12px", fontWeight: 600, color: "var(--muted-foreground)" }}>
                  Action
                </th>
                <th className="text-left p-4" style={{ fontSize: "12px", fontWeight: 600, color: "var(--muted-foreground)" }}>
                  Credits
            ...
            <tbody>
              {creditCostGuide.map((row) => (
                <tr key={row.action} style={{ borderBottom: "1px solid var(--border)" }}>
                  <td className="p-4" style={{ fontSize: "14px", fontWeight: 500, color: "var(--foreground)" }}>
                    {row.action}
                  </td>
                  <td className="p-4" style={{ fontSize: "14px", color: "var(--foreground)" }}>
                    {row.credits}
                  </td>
                  <td className="p-4" style={{ fontSize: "14px", color: "var(--muted-foreground)" }}>
                    {row.result}
                  </td>
                </tr>
              ))}
            ...
            return (
              ...
              >
                ...
                >
                  <span
                    className="pr-4"
                    style={{ fontSize: "15px", fontWeight: 450, color: "var(--foreground)" }}
                  >
                    {faq.q}
                  </span>
                  <span className="flex-shrink-0 transition-colors" style={{ color: "var(--muted-foreground)" }}>
                ...
                <AnimatePresence initial={false}>
                  {isOpen && (
                    ...
                    >
                      <div className="pb-5" style={{ fontSize: "14px", lineHeight: 1.65, color: "var(--muted-foreground)" }}>
                        {faq.a}
                      </div>
                    </motion.div>
                  )}
