  ...
  },
  {
    ...
    agents: [
      ...
      },
      {
        ...
        detail: "Takes the master message and cascades it into every required format — email, LinkedIn, SMS, ads, landing pages, stories, newsletter. Maintains voice consistency while respecting platform constraints.",
      },
    ],
  },
  {
