    ...
    <section id="roles" className="py-20 md:py-28">
      <div className="max-w-[1200px] mx-auto px-6">
        ...
        >
          ...
          <p className="text-muted-foreground max-w-[720px]" style={{ fontSize: "16px", lineHeight: 1.55 }}>
          ...
          {roles.map((role, i) => (
            ...
            >
              <div className="flex items-start justify-between mb-4">
                <h3 className="text-foreground" style={{ fontSize: "17px", fontWeight: 600, letterSpacing: "-0.01em" }}>
                  {role.title}
                </h3>
                <span className="text-muted-foreground italic flex-shrink-0 ml-4" style={{ fontSize: "13.5px" }}>
                  {role.quote}
                </span>
              </div>
